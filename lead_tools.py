...
def varnish_opportunity_score(audit: dict, cdn_info: dict | None = None) -> int:
    """
    ...
    Formula:
      • Speed score       × 0.55   (most direct Varnish impact — increased weight)
...
I can share your full audit PDF on request — it shows exactly where the gaps are and what the projected improvements look like after enabling Varnish Edge Cache.
...
def build_leads_csv(
    ...
    for audit in audit_results:
        ...
        opp      = varnish_opportunity_score(audit, cdn_info=cdn_data.get(url, {}))
